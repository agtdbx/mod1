...
/*   Updated: 2024/12/16 18:24:21 by lflandri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Water::Water()
{
	...
	// this->vertices.push_back(Point(Vec3(this->position.x, this->position.y - WATER_DROP_SIZE, this->position.z), 0, 0, 255));

	// this->vertices.push_back(Point(Vec3(this->position.x + WATER_DROP_SIZE, this->position.y, this->position.z), 0, 255, 0));
	// this->vertices.push_back(Point(Vec3(this->position.x - WATER_DROP_SIZE, this->position.y, this->position.z + WATER_DROP_SIZE), 0, 255, 0));
	// this->vertices.push_back(Point(Vec3(this->position.x - WATER_DROP_SIZE, this->position.y, this->position.z - WATER_DROP_SIZE), 0, 255, 0));
