...
/*   Updated: 2024/12/12 17:22:25 by lflandri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Water::actualiseMeshPosition(void)
{
	...
	vertices.push_back(Point(this->position.x, this->position.y - WATER_DROP_SIZE, this->position.z, 0, 0, 255));

	vertices.push_back(Point(this->position.x + WATER_DROP_SIZE, this->position.y, this->position.z, 0, 255, 0));
	vertices.push_back(Point(this->position.x - WATER_DROP_SIZE, this->position.y, this->position.z + WATER_DROP_SIZE, 0, 255, 0));
	vertices.push_back(Point(this->position.x - WATER_DROP_SIZE, this->position.y, this->position.z - WATER_DROP_SIZE, 0, 255, 0));
...
void Water::calculSelfDensity(std::vector<Water> waterDrops)
{
	...
	{
		double vecTemp = (water.getPosition() - this->position);
